...
import com.example.moviesapp.designsystem.component.MoviesAppNavigationSuiteScaffold
import com.example.moviesapp.navigation.MoviesAppNavHost
...
internal fun MoviesApp(
    ...
    MoviesAppNavigationSuiteScaffold(
